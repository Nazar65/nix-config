...
let
  composerPhar = builtins.fetchurl{
    url = "https://github.com/composer/composer/releases/download/2.2.23/composer.phar";
...
in {
  ...
  env = {
    PROJECT_HOST = "reinders.local:8081";
    APP_ROOT = "/home/nazar/nix-config/environments/web-development/source/reinders";
    DOLLAR="$";
    ...
    DEVENV_DB_NAME = "reinders";
    DEVENV_DB_USER = "reinders";
    DEVENV_DB_PASS = "reinders";
  };
